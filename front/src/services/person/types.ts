...
export interface GetPersonInfoArgs
	extends Omit<SpecificMethodRequestArgs, 'abortSignalKey' | 'url' | 'body'> {
	wcaId: string;
}

export interface GetPersonImageArgs
	extends Omit<SpecificMethodRequestArgs, 'abortSignalKey' | 'url' | 'body'> {
	wcaId: string;
}

export interface GetPersonCurrentRecordsArgs
	extends Omit<SpecificMethodRequestArgs, 'abortSignalKey' | 'url' | 'body'> {
	wcaId: string;
}

export interface GetPersonRankingByModeArgs
	extends Omit<SpecificMethodRequestArgs, 'abortSignalKey' | 'url' | 'body'> {
	mode: CompetitionModes;
	wcaId: string;
}

export interface GetPeopleBySearchArgs
	extends Omit<SpecificMethodRequestArgs, 'abortSignalKey' | 'url' | 'body'>,
		PaginatedQuery {
