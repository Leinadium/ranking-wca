import type { PersonCurrentRecordsViewModel, PersonEventResultViewModel, PersonImageViewModel, PersonInfoViewModel, PeopleSearchViewModel } from "../../viewModels/person/types";
